        ...
        <footer className="bg-gray-100 shadow py-6 mt-auto dark:bg-gray-600">
            <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-4">
                    ...
                    <Link to="/about" className="flex items-center font-semibold text-gray-700 hover:underline dark:text-amber-50">
                        <InformationCircleIcon className="h-4 w-4 mr-1" /> {t('about_link_footer')}
                    </Link>
                    <Link to="/contact" className="flex items-center font-semibold text-gray-700 hover:underline dark:text-amber-50">
                        <PhoneIcon className="h-4 w-4 mr-1" /> {t('contact_link_footer')}
                    </Link>
                    <Link to="/privacy" className="flex items-center font-semibold text-gray-700 hover:underline dark:text-amber-50">
                        <ShieldCheckIcon className="h-4 w-4 mr-1" /> {t('privacy_link_footer')}
                    </Link>
                    <Link to="/help" className="flex items-center font-semibold text-gray-700 hover:underline dark:text-amber-50">
